...
import com.example.tvapp.adapters.EpisodesAdapter;
import com.example.tvapp.adapters.ImageSliderAdapter;
import com.example.tvapp.databinding.ActivityTVShowDetailsBinding;
import com.example.tvapp.databinding.LayoutEpisodesBottomSheetBinding;
import com.example.tvapp.models.TVShow;
import com.example.tvapp.utilities.TempDataHolder;
import com.example.tvapp.viewmodels.TVShowDetailsViewModel;
                ...
                this, tvShowDetailsResponse -> {
                    activityTVShowDetailsBinding.setIsLoading(false);
                        ...
                        activityTVShowDetailsBinding.textReadMore.setOnClickListener(view -> {
                            if (activityTVShowDetailsBinding.textReadMore.getText().toString().equals("Więcej")){
                                activityTVShowDetailsBinding.textDescription.setMaxLines(Integer.MAX_VALUE);
                                activityTVShowDetailsBinding.textDescription.setEllipsize(null);
                                activityTVShowDetailsBinding.textReadMore.setText(R.string.mniej);
                            } else {
                                activityTVShowDetailsBinding.textDescription.setMaxLines(4);
                                activityTVShowDetailsBinding.textDescription.setEllipsize(TextUtils.TruncateAt.END);
                                activityTVShowDetailsBinding.textReadMore.setText(R.string.wi_cej);
                            }
                        });
                        ...
                        activityTVShowDetailsBinding.buttonEpisodes.setOnClickListener(view -> {
                            if (episodesBottomSheetDialog == null) {
                                ...
                                layoutEpisodesBottomSheetBinding.textTitle.setText(
                                        String.format("Odcinki | %s", tvShow.getName())
                                );
                        ...
                        activityTVShowDetailsBinding.imageWatchlist.setOnClickListener(view -> {
                                    ...
                                    if (isTVShowAvailableInWatchlist) {
                                        ...
                                        .subscribe(() -> {
                                            ...
                                            Toast.makeText(getApplicationContext(), "Usunięto z Listy Oglądanych", Toast.LENGTH_SHORT).show();
                                        }));
                                    } else {
                                        compositeDisposable.add(tvShowDetailsViewModel.addtoWatchlist(tvShow)
                                                ...
                                                .subscribe(() -> {
                                                    TempDataHolder.IS_WATCHLIST_UPDATED = true;
                                                    activityTVShowDetailsBinding.imageWatchlist.setImageResource(R.drawable.ic_added);
                                                    Toast.makeText(getApplicationContext(), "Dodano do Listy Oglądanych", Toast.LENGTH_SHORT).show();
                                                    compositeDisposable.dispose();
                                                })
                                        );
                                    }
